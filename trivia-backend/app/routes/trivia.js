 ...
 *     curl -i https://api.aws-user.group/api/trivia/all
 */
 ...
 *
 * @apiExample {curl} Example usage:
 *     curl -i https://api.aws-user.group/api/trivia/question/1
 */
 ...
 *          -d "{'answer' : 'Broomball'}" \
 *          -X POST https://api.aws-user.group/api/trivia/question/1
 */
